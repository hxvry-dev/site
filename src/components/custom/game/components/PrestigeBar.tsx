...
export const PrestigeBar = () => {
	...
	const percentage = `${((gameState.user.currency_balance / gameState.user.prestige_cost) * 100).toFixed(2)}% of the way to Prestige # ${gameState.user.num_times_prestiged + 1}`;
	return (
