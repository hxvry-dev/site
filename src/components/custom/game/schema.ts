...
export type tUpgrade = z.infer<typeof GameStateV2.shape.upgrades>;
export type tUser = z.infer<typeof GameStateV2.shape.user>;
export type tUserUpgrades = z.infer<typeof GameStateV2.shape.userUpgrades>;
